  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="信用分" prop="xinyongfen">
          <el-input v-model="ruleForm.xinyongfen" readonly              placeholder="信用分" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongsi'"  label="账号" prop="zhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongsi'"  label="负责人" prop="fuzeren">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='gongsi'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongsi'"  label="联系电话" prop="lianxidianhua">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongsi'"  label="地址" prop="dizhi">
          <el-input v-model="ruleForm.dizhi"               placeholder="地址" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongsi'"  label="信用分" prop="xinyongfen">
          <el-input v-model="ruleForm.xinyongfen" readonly              placeholder="信用分" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.zhanghao)&& 'gongsi'==this.flag){
      ...
      if( 'gongsi' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
