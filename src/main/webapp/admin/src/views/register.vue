  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='gongsi'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='gongsi'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='gongsi'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='gongsi'">
