<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作品类型" prop="zuopinleixing">
          <el-input v-model="ruleForm.zuopinleixing" 
              placeholder="作品类型" clearable  :readonly="ro.zuopinleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作品类型" prop="zuopinleixing">
              <el-input v-model="ruleForm.zuopinleixing" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作品说明" prop="zuopinshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作品说明"
                  v-model="ruleForm.zuopinshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuopinshuoming" label="作品说明" prop="zuopinshuoming">
                    <span>{{ruleForm.zuopinshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `waibaoxuqiu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.waibaoxuqiuCrossAddOrUpdateFlag = false;
						 this.parent.search();
