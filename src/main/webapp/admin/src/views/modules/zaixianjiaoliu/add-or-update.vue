    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="交流内容" prop="jiaoliuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoliuneirong" label="交流内容" prop="jiaoliuneirong">
                    <span>{{ruleForm.jiaoliuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	yonghuxingming : false,
      ...
      rules: {
          ...
          jiaoliuneirong: [
                { required: true, message: '交流内容不能为空', trigger: 'blur' },
          ],
          fabushijian: [
          ],
          yonghuming: [
  ...
  methods: {
    ...
    zhanghaoChange () {
      this.$http({
        url: `follow/gongsi/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.gongsimingcheng){
                this.ruleForm.gongsimingcheng = data.data.gongsimingcheng
              }
        } else {
          this.$message.error(data.msg);
        }
